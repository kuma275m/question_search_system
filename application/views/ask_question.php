	...
	<div id="container">
		...
		<div style="width:600px;height;auto;margin:0 auto;text-align:center;">
			...
			<form action="<?php echo base_url()."questionController/add_question" ?>" method="post" autocomplete="off" accept-charset="utf-8" id="search" onsubmit="return check(this)">
				...
				<div style="margin:10px;text-weight:bold;">Ask Question</div>
				</div>
				<div style="width:600px; height:auto;margin:0 auto;text-align:left;border:1px solid #4d98e5;">
					<div style="width:400px;margin-left:50px;margin-top:10px;text-weight:bold;"><input style="width:400px;" id="question_title" name="question_title" value="" placeholder="Question Title" /><font id="username_message"></font></div>
					<div style="width:400px;margin-left:50px;margin-top:10px;text-weight:bold;">
						Category:
					...
					<div style="width:400px;margin-left:50px;margin-top:10px;text-weight:bold;">
						<textarea id="question_content" name="question_content" style="width:400px;padding:10px;" placeholder="Question Content"></textarea>
					</div>
					<br />
				</div>
				<br />
